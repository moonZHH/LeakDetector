...
import hk.polyu.analysis.IntraProcedureVariableAnalysis;
import soot.Body;
import soot.G;
...
public class SootEnvironment {
	...
	private static String[] packageWhitelist = new String[] {
			...
			/* OnePlus  */ "cn.oneplus.", "com.oneplus.", "net.oneplus.", 
			/* OPPO     */ "com.coloros.", "com.heytap.", "com.nearme.", "com.oplus.", "com.oppo.", "com.realme", "com.finshell.", "oplus", 
			/* Vivo     */ "com.bbk.", "com.iqoo.", "com.vivo.", 
			/* Meizu    */ "com.flyme.", "com.meizu.", 
			/* MYUI     */ "com.lenovo.", "com.motorola.", "com.zui.", 
	...
	public static void init() {
		...
		// TODO: it would be better to wait for the finish of class loading/parsing
		try {
			Thread.sleep(30 * 1000); // is 30s enough?
		} catch (Exception e) {}
...
//		Options.v().setPhaseOption("cg.cha", "string-constants:true");
		...
		Options.v().setPhaseOption("cg.spark", "ignore-types:true");
	...
	public static void initForAPK(String apkPath) {
		...
		// TODO: it would be better to wait for the finish of class loading/parsing?
		// try {
			// Thread.sleep(0 * 1000); // is 10s enough?
		// } catch (Exception e) {}
